  ...
  <div class="l-budget-creation">
    <v-layout row wrap>
      ...
      <v-layout row wrap v-for="item in budget.items" class="l-budget-item" :key="item.id">
        <v-flex xs12 md1>
          <v-btn block dark color="red lighten-l" @click.native="removeItem(item)">Remove</v-btn>
        </v-flex>
      ...
      <v-flex xs12 md2 offset-md10>
        <v-btn block color="md-add-item-btn light-blue lighten-l" @click.native="addItem()">Add Item</v-btn>
      </v-flex>
      ...
      <v-flex xs12 md2 offset-md10>
        <v-btn block color="md-add-item-btn green lighten-l" @click.native="saveBudget(budget)">Save</v-btn>
      </v-flex>
