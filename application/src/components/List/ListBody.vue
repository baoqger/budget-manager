  ...
  <section class="l-list-body">
    <div class="md-list-item"
      ...
      <div :class="budgetsVisible ? 'l-budget-actions white--text' : 'l-client-actions white--text'">
        <v-btn small flat color="yellow accent-l" @click.native="getItemAndEdit(item)">
          <v-icon>mode_edit</v-icon>
        </v-btn>
        <v-btn small flat color="red lighten-l" @click.native="deleteItem(item, data, budgetsVisible)">
